...
class PipesNonJavaInputFormat implements
	...
	public InputSplit[] getSplits(JobConf job, int numSplits)
		...
		Class<? extends InputFormat> class1 = job.getClass(
				Submitter.INPUT_FORMAT, TextInputFormat.class,
				InputFormat.class);
		return ReflectionUtils.newInstance(class1, job).getSplits(job,numSplits);
	}
